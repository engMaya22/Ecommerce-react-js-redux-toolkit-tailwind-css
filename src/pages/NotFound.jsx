      ...
      <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
          <div>
              ...
              <div className="flex items-center mt-6 gap-x-3">
                  ...
                  <button onClick={()=>navigate('/')} className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-red-500 rounded-lg shrink-0 sm:w-auto hover:bg-red-600 dark:hover:bg-red-500 dark:bg-red-600">
                      Take me home
                  </button>
              </div>
          </div>
